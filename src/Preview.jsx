          ...
          <div className="innerPreview">
            ...
            <div className="previewPlatforms">
              ...
              <div className="gitHubPlatform">
                ...
                <p>GitHub</p>
                <img src={arrowRight} alt="arrow right" className="gitHub-arrow"/>
              </div>

              <div className="youTubePlatform">
                <img src={youtubeImg} alt="gitHub icon" />
                <p>YouTube</p>
                <img src={arrowRight} alt="arrow right" className="youTube-arrow"/>
              </div>

              <div className="linkedInPlatform">
                <img src={linkedInImg} alt="gitHub icon" />
                <p>LinkedIn</p>
                <img src={arrowRight} alt="arrow right" className="linkedIn-arrow"/>
              </div>
